...
Begin VB.Form frmCharInfo 
   ...
   Begin ImpC_Client.uAOButton imgCerrar 
      ...
      PICF            =   "frmCharInfo.frx":001C
      PICH            =   "frmCharInfo.frx":0038
      PICV            =   "frmCharInfo.frx":0054
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgEchar 
      Height          =   495
      Left            =   1320
      TabIndex        =   16
      Top             =   6000
      ...
      FCOL            =   16777215
      OCOL            =   16777215
      PICE            =   "frmCharInfo.frx":0070
      PICF            =   "frmCharInfo.frx":008C
      PICH            =   "frmCharInfo.frx":00A8
      PICV            =   "frmCharInfo.frx":00C4
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgPeticion 
      Height          =   495
      Left            =   2640
      TabIndex        =   17
      Top             =   6000
      ...
      FCOL            =   16777215
      OCOL            =   16777215
      PICE            =   "frmCharInfo.frx":00E0
      PICF            =   "frmCharInfo.frx":00FC
      PICH            =   "frmCharInfo.frx":0118
      PICV            =   "frmCharInfo.frx":0134
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   Begin ImpC_Client.uAOButton imgRechazar 
      ...
      FCOL            =   16777215
      OCOL            =   16777215
      PICE            =   "frmCharInfo.frx":0150
      PICF            =   "frmCharInfo.frx":016C
      PICH            =   "frmCharInfo.frx":0188
      PICV            =   "frmCharInfo.frx":01A4
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   Begin ImpC_Client.uAOButton imgAceptar 
      ...
      FCOL            =   16777215
      OCOL            =   16777215
      PICE            =   "frmCharInfo.frx":01C0
      PICF            =   "frmCharInfo.frx":01DC
      PICH            =   "frmCharInfo.frx":01F8
      PICV            =   "frmCharInfo.frx":0214
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
...
Private Sub Form_Load()
    ...
    Me.Picture = General_Load_Picture_From_Resource("192.bmp", False)
