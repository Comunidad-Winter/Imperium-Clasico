...
Begin VB.Form frmGuildLeader 
   BorderStyle     =   0  'None
   Caption         =   "Administracion del Clan"
   ClientHeight    =   7410
   ClientLeft      =   0
   ClientTop       =   -75
   ClientWidth     =   5985
...
Private Sub Form_Load()
    ...
    Me.Picture = General_Load_Picture_From_Resource("60.bmp", False)
...
Private Sub LoadButtons()
    ...
    Call cBotonElecciones.Initialize(imgElecciones, "36.bmp", _
                                    "37.bmp", _
                                    "38.bmp", Me)

    Call cBotonActualizar.Initialize(imgActualizar, "33.bmp", _
                                    "34.bmp", _
                                    "35.bmp", Me)

    Call cBotonDetallesClan.Initialize(imgDetallesClan, "39.bmp", _
                                    "40.bmp", _
                                    "41.bmp", Me)

    Call cBotonDetallesMiembros.Initialize(imgDetallesMiembros, "42.bmp", _
                                    "43.bmp", _
                                    "44.bmp", Me)
                                    
    Call cBotonDetallesSolicitudes.Initialize(imgDetallesSolicitudes, "45.bmp", _
                                    "46.bmp", _
                                    "47.bmp", Me)

    Call cBotonEditarCodex.Initialize(imgEditarCodex, "48.bmp", _
                                    "49.bmp", _
                                    "50.bmp", Me)

    Call cBotonEditarURL.Initialize(imgEditarURL, "200.bmp", _
                                    "201.bmp", _
                                    "202.bmp", Me)

    Call cBotonPropuestasPaz.Initialize(imgPropuestasPaz, "51.bmp", _
                                    "52.bmp", _
                                    "53.bmp", Me)

    Call cBotonPropuestasAlianzas.Initialize(imgPropuestasAlianzas, "54.bmp", _
                                    "55.bmp", _
                                    "56.bmp", Me)

    Call cBotonCerrar.Initialize(imgCerrar, "57.bmp", _
                                    "58.bmp", _
                                    "59.bmp", Me)
