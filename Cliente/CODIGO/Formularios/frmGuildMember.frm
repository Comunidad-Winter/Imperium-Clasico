...
Private Sub Form_Load()
    ...
    If Language = "spanish" Then
      Me.Picture = General_Load_Picture_From_Resource("120.bmp", False)
    Else
      Me.Picture = General_Load_Picture_From_Resource("121.bmp", False)
    End If
...
Private Sub LoadButtons()
    ...
    Call cBotonDetalles.Initialize(imgDetalles, "117.bmp", _
                                    "118.bmp", _
                                    "119.bmp", Me)

    Call cBotonNoticias.Initialize(imgNoticias, "114.bmp", _
                                    "115.bmp", _
                                    "116.bmp", Me)

    Call cBotonCerrar.Initialize(imgCerrar, "113.bmp", _
                                    "112.bmp", _
                                    "111.bmp", Me)
