...
Private Sub LoadButtons()
    ...
    ' Load pictures
    Set FondosListaMsg(eForumType.ieGeneral) = General_Load_Picture_From_Resource("158.bmp", False)
    Set FondosListaMsg(eForumType.ieREAL) = General_Load_Picture_From_Resource("159.bmp", False)
    Set FondosListaMsg(eForumType.ieCAOS) = General_Load_Picture_From_Resource("160.bmp", False)
    
    Set FondosDejarMsg(eForumType.ieGeneral) = General_Load_Picture_From_Resource("161.bmp", False)
    Set FondosDejarMsg(eForumType.ieREAL) = General_Load_Picture_From_Resource("162.bmp", False)
    Set FondosDejarMsg(eForumType.ieCAOS) = General_Load_Picture_From_Resource("163.bmp", False)
    
    imgMarcoTexto.Picture = General_Load_Picture_From_Resource("164.bmp", False)
    ...
    ' Initialize buttons
    Call cBotonDejarAnuncio.Initialize(imgDejarAnuncio, "155.bmp", _
                                            "156.bmp", _
                                            "157.bmp", Me)
                                            
    Call cBotonDejarMsg.Initialize(imgDejarMsg, "151.bmp", _
                                            "152.bmp", _
                                            "153.bmp", Me, _
                                            "154.bmp")
                                            
    Call cBotonCerrar.Initialize(imgCerrar, "148.bmp", _
                                            "149.bmp", _
                                            "150.bmp", Me)
                                            
    Call cBotonListaMsg.Initialize(imgListaMsg, "165.bmp", _
                                            "166.bmp", _
                                            "167.bmp", Me)
