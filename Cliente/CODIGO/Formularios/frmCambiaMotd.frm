...
Begin VB.Form frmCambiaMotd 
   ...
   Begin ImpC_Client.uAOButton imgAceptar 
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgAzul 
      Height          =   375
      Left            =   480
      TabIndex        =   5
      Top             =   3240
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgRojo 
      Height          =   375
      Left            =   1560
      TabIndex        =   6
      Top             =   3240
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgBlanco 
      Height          =   375
      Left            =   2640
      TabIndex        =   7
      Top             =   3240
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgGris 
      Height          =   375
      Left            =   3720
      TabIndex        =   8
      Top             =   3240
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgMarron 
      Height          =   375
      Left            =   3720
      TabIndex        =   9
      Top             =   3720
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgVerde 
      Height          =   375
      Left            =   2640
      TabIndex        =   10
      Top             =   3720
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgMorado 
      Height          =   375
      Left            =   1560
      TabIndex        =   11
      Top             =   3720
      ...
      EndProperty
   End
   Begin ImpC_Client.uAOButton imgAmarillo 
      Height          =   375
      Left            =   480
      TabIndex        =   12
      Top             =   3720
...
Private Sub Form_Load()
    ...
    Me.Picture = General_Load_Picture_From_Resource("102.bmp", False)
    
    Call LoadTextsForm

    Set picNegrita = General_Load_Picture_From_Resource("101.bmp", False)
    Set picCursiva = General_Load_Picture_From_Resource("100.bmp", False)
End Sub
