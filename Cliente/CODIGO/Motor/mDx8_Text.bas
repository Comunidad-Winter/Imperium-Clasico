...
Sub Engine_Init_FontTextures()
    ...
    For i = 1 To UBound(cfonts)
        ...
        InfoHead = File_Find(Carga.Path(ePath.recursos) & "\Fuentes" & Formato, "font" & CStr(i) & ".png")
...
Sub Engine_Init_FontSettings()
    ...
    For i = 1 To UBound(cfonts)
        ...
        InfoHead = File_Find(Carga.Path(ePath.recursos) & "\Fuentes" & Formato, LCase$("Font" & i & ".dat"))
