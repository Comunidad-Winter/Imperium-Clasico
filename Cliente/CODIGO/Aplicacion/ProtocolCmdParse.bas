...
'***************************************************
    ...
    If Left$(Comando, 1) = "/" Then
        ...
        Select Case Comando
            ...
            Case "/PROPONER"
                If notNullArguments Then
                    Call WriteCasament(ArgumentosRaw)
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /PROPONER NICKNAME.", , , , True, True)
                End If

            Case "/DIVORCIAR"
                If notNullArguments Then
                    Call WriteDivorciate(ArgumentosRaw)
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /DIVORCIAR NICKNAME.", , , , True, True)
                End If
 
            Case "/ACEPTO"
                If notNullArguments Then
                    Call WriteAcepto(ArgumentosRaw)
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /ACEPTO NICKNAME.", , , , True, True)
                End If
                '@@ Cr3p casamiento
            ...
            Case "/METEO"
                ...
                Else
                    ...
                    Else
                        Call ShowConsoleMsg(JsonLanguage.item("MENSAJE_VALOR_INCORRECTO").item("TEXTO") & " /METEO 0: Random, 1: Lluvia")
                    End If
                End If
